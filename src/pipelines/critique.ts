...
export async function critique(env: Env, prompt: string, prefer: "anthropic" | "openrouter" | "workers_ai" = "openrouter") {
  // Critique requires careful analysis - use a high-quality provider
  let provider;
  ...
  try {
    ...
    obj = { error: "CRITIQUE_JSON_PARSE_FAILED", raw: r.text, provider: r.provider };
  }
